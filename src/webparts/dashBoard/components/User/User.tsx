...
import {Table,TableBody,TableCell,TableContainer,TableHead,TableRow,Paper,IconButton,Grid,Typography,Avatar,Box, TablePagination, DialogTitle, Dialog, styled} from '@mui/material';
    ...
    <div className={styles.dashBoard}>
      ...
      <Grid container spacing={2} alignItems="center">
        <Grid item>
          ...
          <Avatar alt={userRecords.EmployeeName} src={`${props.context.pageContext.web.absoluteUrl}/_layouts/15/userphoto.aspx?accountname=${userRecords.EmployeeName}&Size=S`} />
        </Grid>
        <Grid item>
